      ...
      <section className="bg-white w-full py-20">
        <div className="responsive-container px-5 sm:px-auto flex flex-wrap gap-10 xl:gap-20     text-lg md:text-xl leading-10 font-thin">
            ...
            <ul>
              ...
              <li className="hover:text-purple-primary pl-4 cursor-pointer">
                <svg
                  ...
                  height="25"
                  fill="green"
                  className="bi bi-globe inline-block mr-2 "
                  viewBox="0 0 16 16"
                >
              ...
              <li className="hover:text-purple-primary pl-4 cursor-pointer">
                <svg
                  ...
                  height="25"
                  fill="green"
                  className="bi bi-telephone inline-block mr-2"
                  viewBox="0 0 16 16"
                >
              ...
              <li className="hover:text-purple-primary pl-4 cursor-pointer">
                <svg
                  ...
                  height="25"
                  fill="green"
                  className="bi bi-envelope inline-block mr-2"
                  viewBox="0 0 16 16"
                >
          ...
          <div>
            ...
            />
            <button className=" rounded-full px-2 py-1  bg-green-primary hover:bg-purple-primary">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="18"
                height="18"
      ...
      <section className="w-full py-5 bg-green-primary relative">
        <div className="responsive-container px-5 sm:px-auto">
          <div className="flex  items-center m-auto flex-wrap gap-4 md:gap-0">
            ...
            <div className="social-icons grid grid-cols-6 xl:grid-cols-10 gap-2 md:ml-10">
              ...
              <div className="xl:col-span-5 col-span-1"></div>
            </div>
