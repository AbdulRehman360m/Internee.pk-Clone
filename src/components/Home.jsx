        ...
        <div className="responsive-container">
          ...
          <div className="lg:mx-20 mx-1 sm:mx-5 categories flex flex-wrap items-center justify-center gap-5">
            ...
            <div className="item rounded-full m-auto  bg-green-primary px-2 w-36 h-36 border-8 border-purple-primary hover:border-white hover:shadow-lg shadow-black outline-purple-primary cursor-pointer transition-all ease-in-out duration-300 relative flex items-center justify-center flex-col gap-3">
              <div className="absolute top-0  right-0  bg-purple-primary rounded-full text-white px-2 py-1">05</div>
              {/* svg */}
              <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="white" className="bi bi-window inline-block" viewBox="0 0 16 16">
              ...
              <h3 className="text-white text-center text-sm font-thin">Website Designing</h3>
            </div>
            ...
            <div className="item rounded-full m-auto  bg-green-primary px-2 w-36 h-36 border-8 border-purple-primary hover:border-white hover:shadow-lg shadow-black outline-purple-primary cursor-pointer transition-all ease-in-out duration-300 relative flex items-center justify-center flex-col gap-3">
              <div className="absolute top-0  right-0  bg-purple-primary rounded-full text-white px-2 py-1">05</div>
              {/* svg */}
              <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="white" className="bi bi-globe" viewBox="0 0 16 16">
              ...
              <h3 className="text-white text-center text-sm font-thin">Web Development</h3>
            </div>
            ...
            <div className="item rounded-full m-auto  bg-green-primary px-2 w-36 h-36 border-8 border-purple-primary hover:border-white hover:shadow-lg shadow-black outline-purple-primary cursor-pointer transition-all ease-in-out duration-300 relative flex items-center justify-center flex-col gap-3">
              <div className="absolute top-0  right-0  bg-purple-primary rounded-full text-white px-2 py-1">05</div>
              {/* svg */}
              <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="white" className="bi bi-robot" viewBox="0 0 16 16">
              ...
              <h3 className="text-white text-center text-sm font-thin">CRM&apos;s and Chatbot Development</h3>
            </div>
            ...
            <div className="item rounded-full m-auto  bg-green-primary px-2 w-36 h-36 border-8 border-purple-primary hover:border-white hover:shadow-lg shadow-black outline-purple-primary cursor-pointer transition-all ease-in-out duration-300 relative flex items-center justify-center flex-col gap-3">
              <div className="absolute top-0  right-0  bg-purple-primary rounded-full text-white px-2 py-1">05</div>
              {/* svg */}
              <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="white" className="bi bi-vector-pen" viewBox="0 0 16 16">
              ...
              <h3 className="text-white text-center text-sm font-thin">Graphic Designing & 3D Modeling</h3>
            </div>
            ...
            <div className="item rounded-full m-auto  bg-green-primary px-2 w-36 h-36 border-8 border-purple-primary hover:border-white hover:shadow-lg shadow-black outline-purple-primary cursor-pointer transition-all ease-in-out duration-300 relative flex items-center justify-center flex-col gap-3">
              <div className="absolute top-0  right-0  bg-purple-primary rounded-full text-white px-2 py-1">05</div>
              {/* svg */}
              <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="white" className="bi bi-phone" viewBox="0 0 16 16">
              <path d="M11 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1zM5 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2z"/>
              <path d="M8 14a1 1 0 1 0 0-2 1 1 0 0 0 0 2"/>
            </svg>
              <h3 className="text-white text-center text-sm font-thin">Mobile Application Development</h3>
            </div>
